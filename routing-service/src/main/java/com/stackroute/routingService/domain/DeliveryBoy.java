...
public class DeliveryBoy {
    ...
    public DeliveryBoy(Long id, String deliveryBoyId, String deliveryBoyName, String status, String location, List<Restaurant> restaurants, List<Charity> charities) {
        this.id = id;
