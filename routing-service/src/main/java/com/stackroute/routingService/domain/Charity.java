...
public class Charity {
    ...
    public Charity(Long id, String charityId, String charityName, String foodRequirement, String location, String foodAvailable, double precedence, List<Restaurant> restaurants, List<PropertiesRC> propertiesRC) {
        this.id = id;
        ...
        this.propertiesRC = propertiesRC;
    }
